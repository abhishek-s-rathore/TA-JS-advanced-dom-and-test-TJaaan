...
var lodash = require("lodash"); //==========Using Moment.============//
...
document.write("<br>");
document.write(moment([2020]).isLeapYear()); //==========Using Lodash.============//

var array1 = [0, false, 1, 2, 3, 4, 5, 6];
var array2 = [3, 4, 5, 6, 7, 8]; //Array methods
...
console.log(lodash.drop(array2, 2)); // Collection methods

console.log(lodash.countBy([6.1, 4.2, 6.3], Math.floor));
var lastItem = lodash.findLast([1, 2, 3, 4], function (n) {
  return n % 2 == 1;
});
